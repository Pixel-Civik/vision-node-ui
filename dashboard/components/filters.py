...
def build_sidebar_filters(sites, channels, zones, events):
    ...
    if preset != prev:
        if preset == "Canal 101: Entradas/Salidas + Pasantes":
            ...
            st.session_state["filter_hours"] = (8, 23)
            ...
            st.session_state["filter_hours"] = (0, 23)
    ...
    hour_min, hour_max = st.slider("Rango Horario", min_value=0, max_value=23, value=(8, 23), key="filter_hours")
